...
/**
 * Confirmation semantics on top of the shared AppDialog primitive.
 * External API (props/emits) is unchanged — consumers keep working while the
 * focus/Esc/layer machinery now lives in Reka via AppDialog.
 */
...
<template>
  <AppDialog
    ...
    :described-by="description ? 'confirm-description' : undefined"
    @close="emit('cancel')"
  >
    <div class="confirm-body" :class="{ 'confirm-body--loading': loading }">
